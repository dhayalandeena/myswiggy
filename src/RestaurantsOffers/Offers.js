...
const Offers=()=>
{
  ...
  {
  // console.log(ele,"oooooo")
  const dd=offer.filter((ee)=>{return(ee.cuisines.split(',').map(item=>item.trim()).includes(ele))})
  // console.log("ppp",ee.cuisines.split(',').map(item=>item.trim()).includes(ele)))
...
const applayfilter=()=>
{
  ...
  if(selectoffers)
  {
    updatedlist=updatedlist.sort((a,b)=>(parseFloat(b.offerRange) - parseFloat(a.offerRange))) 
  }

  if(selectfastdelivery)
  {
    updatedlist=updatedlist.sort((a,b)=>(parseFloat(a.dtime) - parseFloat(b.dtime)))
  }
   
  if(selectrating)
  {
    updatedlist=updatedlist.sort((a,b)=>(parseFloat(b.rating) - parseFloat(a.rating)))
  ...
  if(selectpureveg)
  {
    updatedlist=updatedlist.filter((ele)=>{return ele.vegORnonveg==="pureveg"}) 
  }
  

  if(selectmediumrate)
  {
    updatedlist=updatedlist.filter((ele)=>{return ele.fortwopepole>=300 })
  }
  ...
  {
    updatedlist=updatedlist.sort((a,b)=>(parseFloat(a.fortwopepole) - parseFloat(b.fortwopepole)))
  }

  if(sorthoverratio==="sortbyoption5")
  {
    updatedlist=updatedlist.sort((a,b)=>(parseFloat(b.fortwopepole) - parseFloat(a.fortwopepole))) 
  }
  ...
  {
    updatedlist=updatedlist.filter((ele)=>{return ele.location==="Adayar"}) 
  }
  if(swiggyarived==="exswiggy")
  {
    updatedlist=updatedlist.filter((ele)=>{return ele.location==="Avadi"})
  }

  if(ratinghoverdata==="rating1")
  {
    updatedlist=updatedlist.filter((ele)=>{return ele.rating===4.5})
  }
  
  if(ratinghoverdata==="rating2")
  {
    updatedlist=updatedlist.filter((ele)=>{return ele.rating===4.1})
  }
  
  if(ratinghoverdata==="rating3")
  {
    updatedlist=updatedlist.filter((ele)=>{return ele.rating===3.7})
  }
  ...
  {
    updatedlist=updatedlist.filter((ele)=>{return ele.vegORnonveg==="Nonveg"})
  }
  ...
  if(hovercuisines)
  {
    console.log(hovercuisines) 
   updatedlist=updatedlist.filter((ele)=>{return ele.cuisines.split(',').map(item=>item.trim()).includes(hovercuisines)})
  }
...
},[offer,selectoffers,selectfastdelivery,selectrating,selectpureveg,selectmediumrate,selectlowprice,
  sorthoverratio])
  ...
  const cardItem=()=>{
    ...
    <div className="offer-container">
      <div className="offer-row">
        ...
        {(Temparr.length==0?offer:Temparr).slice(0,showDataCount).map((ele, ind) => {
      ...
      {(filterDataShow<Temparr.length)?<div className="showDiv">
          <button onClick={handleFilterShow} className="showbtn">Show more<span>
    ...
    const OffHead=()=>
    {
      ...
      window.addEventListener('scroll', changeNavbarHed);
        ...
        return(
            ...
            <button className="searchbtn" onClick={handleSearch}><div className="serchbrletter">Search for restaurant and food</div>
    ...
    const Offerbar=()=>
    {
      ...
      window.addEventListener('scroll', changeNavbarHed);
        ...
        return(
            ...
            <div>
            <button className={selectoffers===true?"ONbtn":"filtersbtns"}  
            onClick={selectoffers===true?()=>setselectofers(false):()=>setselectofers(true)}   >Offers</button>
            </div>

            <div>
            <button className={selectfastdelivery===true?"ONbtn":"filtersbtns" } 
            onClick={selectfastdelivery===true?()=>setselectfastdelivery(false):()=>setselectfastdelivery(true)}  >Fast Delivery</button>
            </div>

            <div>
            <button className={selectrating===true?"ONbtn":"filtersbtns" } 
            onClick={selectrating===true?()=>setselectratin(false):()=>setselectratin(true)} >Ratings 4.0+</button>
            </div>

            <div>
            <button className={selectpureveg===true?"ONbtn":"filtersbtns" }  
            onClick={selectpureveg===true?()=>setselectpureveg(false):()=>setselectpureveg(true)}  >Pure Veg</button>
            </div>

            <div>
            <button className={selectlowprice===true?"Hidebun":selectmediumrate===true?"ONbtn":"filtersbtns" } 
            onClick={selectmediumrate===true?()=>setselectmediumrate(false):()=>setselectmediumrate(true)}  >Rs.300 - Rs.600</button>
            </div>

            <div>
            <button className={selectmediumrate===true?"Hidebun":selectlowprice===true?"ONbtn":"filtersbtns" }
            onClick={selectlowprice===true?()=>setselectlowprice(false):()=>setselectlowprice(true)}  >Less than Rs.300</button>
            </div>
        ...
        return(
            ...
            <div className="hoverpage" >
                ...
                <div className="hoverfooder">
                    ...
                    <button className="clearfilterbtn" onClick={hoverclearbtn}>Clear Filters</button>
                    <button className="filterapllybtn" onClick={applayfilter} >Apply</button>
...
//use state for conditional rendering for hover page
   ...
   const sorthover=()=>
   {
    return(
        ...
        <br/>
        <div><input type="radio" name="relevance" value="sortbyoption1" 
        checked={sorthoverratio==="sortbyoption1"} onChange={sortbyoncange} />Relevance(Default)</div>
        <br/>
        <div><input type="radio" name="deliverytime" value="sortbyoption2" 
        checked={sorthoverratio==="sortbyoption2"} onChange={sortbyoncange} />Delivery Time</div>
        <br/>
        <div><input type="radio" name="rating" value="sortbyoption3"
        checked={sorthoverratio==="sortbyoption3"} onChange={sortbyoncange} />Rating</div>
        <br/>
        <div><input type="radio" name="lowtohigh" value="sortbyoption4" 
        checked={sorthoverratio==="sortbyoption4"} onChange={sortbyoncange} />Cost:Low to High</div>
        <br/>
        <div><input type="radio" name="hightolow" value="sortbyoption5" 
        checked={sorthoverratio==="sortbyoption5"} onChange={sortbyoncange} />Cost:High to Low</div>
        </div>
        </div>
        </>
    )
   ...
   const Delivertimehover=()=>
   {
    return(
        ...
        <div>Filter by</div>
        <br/>
        <div><input type="checkbox" value="timeoption" 
        onChange={deliverytimechange} />Fast Delivery</div>
        </div>
        </>
    )
   }  
   ...
   const Cuisineshover=()=>
   {
    return(
        ...
        <div style={{display:"grid"}}>
        <br/>
        <div><input type="checkbox" value={ele} onChange={cuisinesselect}  />{ele}</div>
        <br/>   
        </div>)}
   ...
   const Explorehover=()=>
   {
    return(
        ...
        <div>Filter by</div>
        <br/>
        <div><input type="checkbox"value="newswiggy" 
         onChange={swiggyarivedchange}  />New On Swiggy</div>
        <br/>
        <div><input type="checkbox" value="exswiggy" 
         onChange={swiggyarivedchange} />Swiggy Exclusive</div>
        </div>
        </>
    )
   }  
   ...
   const Ratinghover=()=>
   {
    return(
        ...
        <div>Filter by</div>
        <br/>
        <div><input type="checkbox" value="rating1" 
        onChange={ratinghoverchange}  />Rating 4.5+</div>
        <br/>
        <div><input type="checkbox" value="rating2" 
         onChange={ratinghoverchange} />Rating 4.0+</div>
        <br/>
        <div><input type="checkbox" value="rating3" 
        onChange={ratinghoverchange}  />Rating 3.5+</div>
        </div>
        </>
    )
   }  
   ...
   const Vegornonveg=()=>
   {
    return(
        ...
        <div>Filter by</div>
        <br/>
        <div><input type="radio" value="pureveg1" 
        checked={vegornonveghoverdata==="pureveg1"} onChange={vegornonveghoverchange} />Pure veg</div>
        <br/>
        <div><input type="radio" value="nonveg2" 
        checked={vegornonveghoverdata==="nonveg2"} onChange={vegornonveghoverchange} />Non-veg</div>
        </div>
        </>
    )
   } 
   ...
   const offerhover=()=>
   {
    return(
        ...
        <br/>
        <div><input type="radio" value="hoveroffer1" 
        checked={hoveroffer==="hoveroffer1"} onChange={hoverofferchange} />Offers</div>
        </div>
        </>
        )
   }
   ...
   const Costfortwohover=()=>
   {
    return(
        ...
        <div>Filter by</div>
        <br/>
        <div><input type="checkbox" value="rate1" 
        checked={hoverratefortwo==="rate1"} onChange={ratefortwochange} />Rs. 300-Rs. 600</div>
        <br/>
        <div><input type="checkbox" value="rate2" 
        checked={hoverratefortwo==="rate2"} onChange={ratefortwochange} />Less than Rs. 300</div>
        </div>
        </>
    )
   }  
...
const Sortbydrop=()=>
{
    ...
    return(
        ...
        <input type="radio" name="relevance" value="sortbyoption1" 
        checked={sorthoverratio==="sortbyoption1"} onChange={sortbyoncange}   />
        </div>
        ...
        <div className="inputround">
        <input input type="radio" name="deliverytime" value="sortbyoption2" 
        checked={sorthoverratio==="sortbyoption2"} onChange={sortbyoncange}  />
        </div>
        ...
        <div className="inputround">
        <input type="radio" name="rating" value="sortbyoption3"
        checked={sorthoverratio==="sortbyoption3"} onChange={sortbyoncange}  />
        </div>
        ...
        <div className="inputround">
        <input type="radio" name="lowtohigh" value="sortbyoption4" 
        checked={sorthoverratio==="sortbyoption4"} onChange={sortbyoncange}  />
        </div>
        ...
        <div className="inputround">
        <input type="radio" name="hightolow" value="sortbyoption5" 
        checked={sorthoverratio==="sortbyoption5"} onChange={sortbyoncange}  />
        </div>
